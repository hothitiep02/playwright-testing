...
- Name: leave.spec.ts >> Leave Module @leave >> TC-LV-00 - Pre-requisite: Create employee and assign entitlement balance
- Location: src\tests\leave.spec.ts:26:7
...
Call log:
  - waiting for locator('.oxd-main-menu-item:has-text("Leave")') to be visible
