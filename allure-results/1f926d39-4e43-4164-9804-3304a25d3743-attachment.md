...
- Location: src\tests\pim.spec.ts:58:5
...
Call log:
  - waiting for locator('.orangehrm-tabs-item:has-text("Emergency Contacts")') to be visible
...
- generic [ref=e3]:
  ...
  - generic [ref=e144]:
    - alert [ref=e146]:
      - generic [ref=e147]:
        - generic [ref=e148]: 
        - paragraph [ref=e149]: No Records Found
    - generic [ref=e151]:
      - paragraph [ref=e152]: OrangeHRM OS 5.8
      - paragraph [ref=e153]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=e154] [cursor=pointer]:
