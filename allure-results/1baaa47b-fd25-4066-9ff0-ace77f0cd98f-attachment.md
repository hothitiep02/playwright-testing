...
Call log:
  - waiting for locator('button:has-text("Add")').first()
    - locator resolved to <button type="button" data-v-10d463b7="" data-v-7044e35a="" class="oxd-button oxd-button--medium oxd-button--secondary">…</button>
    ...
    - generic [ref=e146]:
      ...
      - generic [ref=e226]:
        ...
        - table [ref=e235]:
          ...
          - rowgroup [ref=e266]:
            - row " 10982 John Doe  " [ref=e268] [cursor=pointer]:
              - cell "" [ref=e269]:
                - generic [ref=e272]:
                  - checkbox "" [ref=e273]
                  - generic [ref=e275]: 
              - cell "10982" [ref=e276]:
                - generic [ref=e277]: "10982"
              - cell "John" [ref=e278]:
