...
- Name: auth\login.spec.ts >> Login & Session Management Tests @login >> TC-AUTH-02: Login with invalid password @regression
- Location: src\tests\auth\login.spec.ts:17:7
        ...
        - generic [ref=e16]:
          ...
          - generic [ref=e25]:
            - generic [ref=e26]:
              - generic [ref=e27]: 
              - generic [ref=e28]: 密碼
            - textbox "密碼" [active] [ref=e30]: wrongpassword
